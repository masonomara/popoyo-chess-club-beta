            ...
            <Link href="/weekly" className={styles.winnerCard}>
              ...
              <div className={styles.winnerBody}>
                ...
                <p className={styles.winnerRecord}>
                  {weekWinner.wins}W – {weekWinner.losses}L – {weekWinner.draws}
                  D
                </p>
              </div>
            </Link>
            ...
            <Link href="/monthly" className={styles.winnerCard}>
              ...
              <div className={styles.winnerBody}>
                <p className={styles.winnerLabel}>
                  {monthName(monthWinner.month_start)}&apos;s Player of the
                  Month
                </p>
                <p className={styles.winnerName}>
                ...
                <p className={styles.winnerRecord}>
                  {monthWinner.wins}W – {monthWinner.losses}L –{" "}
                  {monthWinner.draws}D
                </p>
              </div>
            </Link>
      ...
      <div>
        ...
        <ul className={styles.gameList}>
          {(games ?? []).map((game) => {
            ...
            const winner =
              game.result === "player2_win" ? game.player2 : game.player1;
            const loser =
              game.result === "player2_win" ? game.player1 : game.player2;
            return (
              <li key={game.id}>
                <Link href={`/games/${game.id}`} className={styles.gameRow}>
                  {isDraw ? (
                    <>
                      ...
                      <span className={styles.gameLoser}>
